...
interface EspecialidadDetalleMejoradoProps {
  especialidad: Especialidad;
}

const EspecialidadDetalleMejorado = ({ especialidad }: EspecialidadDetalleMejoradoProps) => {
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {especialidad.doctores && especialidad.doctores.map((doctor) => {
              console.log(`🔍 Verificando doctor: ${doctor.nombre}`);
                  ...
                  <CardHeader className="text-center pb-4">
                    ...
                    <CardTitle className="text-xl text-hospital-primary flex items-center justify-center gap-2">
                      ...
                      {doctor.hasDetailedProfile && (
                        <div className="w-2 h-2 bg-green-500 rounded-full" title="Perfil detallado disponible"></div>
                      )}
                    </CardTitle>
...
export default EspecialidadDetalleMejorado;
