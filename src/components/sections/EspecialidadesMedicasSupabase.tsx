...
const EspecialidadesMedicasSupabase = () => {
    ...
    return (
      <section className="section-padding bg-white">
        <div className="container-custom text-center">
          ...
          <p className="text-lg">Cargando especialidades...</p>
        </div>
      </section>
    );
  }
  ...
  if (!especialidades || especialidades.length === 0) {
    return (
      <section className="section-padding bg-white">
        <div className="container-custom text-center">
          <p className="text-lg text-hospital-gray">No hay especialidades disponibles</p>
        </div>
      </section>
    );
  }
                  ...
                  <CardContent className="p-0 h-48 relative">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center p-6">
                      <div className="w-16 h-16 bg-hospital-primary/10 rounded-full flex items-center justify-center mb-4 group-hover:bg-hospital-primary group-hover:scale-110 transition-all duration-300">
                        <IconComponent className="w-8 h-8 text-hospital-primary group-hover:text-white transition-colors duration-300" />
                      </div>
...
export default EspecialidadesMedicasSupabase;