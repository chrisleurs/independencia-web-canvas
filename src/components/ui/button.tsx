...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-95",
  {
    variants: {
      variant: {
        default: "bg-hospital-primary text-white hover:bg-hospital-blue-dark hover:-translate-y-0.5 shadow-lg hover:shadow-xl",
        destructive:
        ...
        secondary:
          "bg-hospital-secondary text-white hover:bg-hospital-secondary/90 hover:-translate-y-0.5 shadow-lg hover:shadow-xl",
      ...
      size: {
        default: "h-11 px-6 py-3 min-h-[44px]", // Minimum touch target
        sm: "h-9 rounded-md px-4 min-h-[36px]",
        lg: "h-13 rounded-lg px-8 py-4 text-base min-h-[52px]", // Better for mobile
